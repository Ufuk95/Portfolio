...
export class PortfolioComponent {
  ...
  projects: { imgsrc: string, name: string, environment: string, text: string }[]  = [
    { imgsrc: '/img/portfolio/joinPortfolio.png', name: 'Join', environment: 'JavaScript | HTML | CSS | Firebase', text: 'Task manager inspired by the Kanban System. Create and organize tasks using drag and drop functions, assign users and categories.'},
